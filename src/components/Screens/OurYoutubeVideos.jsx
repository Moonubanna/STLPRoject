...
export default class OurYoutubeVideos extends React.PureComponent {
    constructor(props) {
        super(props)
        this.state = {
    ...
    componentDidMount() {
        console.log('componentDidMount of OurYoutubeVideos screen')
        Orientation.lockToPortrait();
    }
    componentWillUnmount() {
        console.log('componentWillUnmount of OurYoutubeVideos screen')
    }
    onBackPress = () => {
