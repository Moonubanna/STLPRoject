...
export default class STLYoutubeVideos extends React.PureComponent {
    constructor(props) {
        super(props)
        this.state = {
    ...
    componentDidMount() {
        console.log('componentDidMount of STLYoutubeVideos screen')
        Orientation.lockToPortrait();
    }
    componentWillUnmount() {
        console.log('componentWillUnmount of STLYoutubeVideos screen')
    }
    onBackPress = () => {
        ...
        return (
            <View style={{
                ...
                <CommonHeaderHome
                    ...
                    isRightIcon={false}
                    isRightNoti={true}
                    header={translate('HEADER_STL_YOUTUBE_VIDEOS')} />
