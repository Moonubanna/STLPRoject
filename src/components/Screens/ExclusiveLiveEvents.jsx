...
export default class ExclusiveLiveEvents extends React.PureComponent {
    constructor(props) {
        super(props)
        this.state = {
    ...
    componentDidMount() {
        console.log('componentDidMount of ExclusiveLiveEvents screen')
        Orientation.lockToPortrait();
    }
    componentWillUnmount() {
        console.log('componentWillUnmount of ExclusiveLiveEvents screen')
    }
    onBackPress = () => {
        ...
        return (
            <View style={{
                ...
                <CommonHeaderHome
                    ...
                    isRightIcon={false}
                    isRightNoti={true}
                    header={translate('HEADER_EXCLUSIVE_LIVE_EVENT')} />
    ...
    stlCourseVerticalItem = (item, index) => {
        ...
        return (
            <CardView
                ...
                onPress={()=>{
                    if(index == 0)
                    NavigationService.navigate({ routeName: SCREEN.SCREEN_EXCLUSIVE_LIVE_TCONDITION, params: { param: {} }, });
                    else
                    NavigationService.navigate({ routeName: SCREEN.SCREEN_EXCLUSIVE_LIVE_EVENT_DETAIL, params: { param: {} }, });
                }}>
                    <Image
                        style={{
                            width: '100%',
