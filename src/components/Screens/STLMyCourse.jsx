...
export default class STLMyCourse extends React.PureComponent {
    constructor(props) {
        super(props)
        this.state = {
    ...
    componentDidMount() {
        console.log('componentDidMount of STLMyCourse screen')
        Orientation.lockToPortrait();
    }
    componentWillUnmount() {
        console.log('componentWillUnmount of STLMyCourse screen')
    }
    onBackPress = () => {
        ...
        return (
            <View style={{
                ...
                <CommonHeaderHome
                    ...
                    isRightIcon={false}
                    isRightNoti={true}
                    header={translate('HEADER_MY_COURSES')} />
    ...
    stlCourseVerticalItem = (item, index) => {
        ...
        return (
            <CardView
                ...
                onPress={()=>{
                    NavigationService.navigate({ routeName: SCREEN.SCREEN_STL_COURSE_PROGRAMS, params: { param: {screen_name:'Drawer'} }, });
                }}>
                    <Image
                        style={{
                            width: '30%',
