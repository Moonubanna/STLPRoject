...
export default class ExclusiveLiveTCondition extends React.PureComponent {
    constructor(props) {
        super(props)
        this.state = {
    ...
    componentDidMount() {
        console.log('componentDidMount of ExclusiveLiveTCondition screen')
        Orientation.lockToPortrait();
    }
    componentWillUnmount() {
        console.log('componentWillUnmount of ExclusiveLiveTCondition screen')
    }
    onBackPress = () => {
        ...
        return (
            <View style={{
                ...
                <CommonHeaderHome
                    ...
                    isRightIcon={false}
                    isRightNoti={true}
                    header={translate('HEADER_EXCLUSIVE_LIVE_VIEW')} />
                <ScrollView
                    ...
                    <View style={{
                        ...
                        <CardView
                            ...
                            <Ripple style={{
                                ...
                                disabled={false}
                                onPress={() => {
                                    NavigationService.navigate({ routeName: SCREEN.SCREEN_EXCLUSIVE_LIVE_PAY, params: { param: { screen_name: {} } }, });
                                }}>
                                {
                                    <Text style={{
                                        color: colors.white,
