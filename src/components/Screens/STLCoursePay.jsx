...
export default class STLCoursePay extends React.PureComponent {
    constructor(props) {
        super(props)
        this.state = {
    ...
    componentDidMount() {
        console.log('componentDidMount of STLCoursePay screen')
        Orientation.lockToPortrait();
    }
    componentWillUnmount() {
        console.log('componentWillUnmount of STLCoursePay screen')
    }
    onBackPress = () => {
                        ...
                        <CardView
                            ...
                            <View
                                style={{
                                    ...
                                    {this.state.previousScreenName != undefined && this.state.previousScreenName == translate('STL_COURSES') ?
                                <View style={{
